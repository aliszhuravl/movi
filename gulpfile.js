...
gulp.task('watch', function() {
    ...
    gulp.watch(path.watch.img,  {usePolling: true}, gulp.series('image:build'));
    gulp.watch(path.watch.img,  {usePolling: true}, gulp.series('svg:build'));
    gulp.watch(path.watch.js,  {usePolling: true}, gulp.series('js:build'));
    gulp.watch(path.watch.img, {usePolling: true},  gulp.series('libs:build'));
    gulp.watch(path.watch.img,  {usePolling: true}, gulp.series('fonts:build'));
